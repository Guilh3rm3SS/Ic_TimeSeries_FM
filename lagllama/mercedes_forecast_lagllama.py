...
def create_sliding_window_dataset(series, start_time, freq, context_length, prediction_length, stride=1, train_ratio=0.5):
    dataset = []
    ...
    # Definir índice de corte para treino e teste
    split_idx = int(len(dataset) * train_ratio)

    train_dataset = ListDataset(dataset[:split_idx], freq=freq)
    test_dataset = ListDataset(dataset[split_idx:], freq=freq)
...
def finetune(context_length, prediction_length, num_samples=1, test=None, train=None, forecast_name="forecast"):
    ...
    estimator = LagLlamaEstimator(
            ...
            trainer_kwargs = {"max_epochs": 1,}, # <- lightning trainer arguments
        )
...
forecast_name="blabla"
# context_length = 32
# prediction_length = 7
stride = 1  # Ex: prever a cada 8 passos

hyperparams = [(32, 1), (32, 7), (32, 15), (32, 30), (160, 1), (160, 7), (160, 15), (160, 30), (352, 1), (352, 7), (352, 15), (352, 30)]
# hyperparams = [(32, 1), (32, 7)]
...
# Obter as previsões
# simple_data = get_lag_llama_predictions(dataset=sliding_dataset, prediction_length=prediction_length, context_length=context_length,  device=device, num_samples=1, forecast_name=forecast_name)
# simple_data
...
for context_len, horizon_len in hyperparams:
    print(f"Agora prevendo com Context Length: {context_len}, Horizon Length: {horizon_len}")
    train_dataset, test_dataset = create_sliding_window_dataset(
        series=series,
        start_time=start_time,
        freq=freq,
    ...
    simple_data = get_lag_llama_predictions(dataset=test_dataset, prediction_length=horizon_len, context_length=context_len, device=device, num_samples=1, forecast_name=simple_name)
...
output_path = "Mercedes_forecast_LagLlama_zero.csv"
